...
```bash
export JUNOS_MCP_URL=https://your-junos-mcp-server.example/mcp/
...
nat validate --config_file examples/h-orchestrator/gated-junos-mcp/workflow.yaml
nat run --config_file examples/h-orchestrator/gated-junos-mcp/workflow.yaml \
