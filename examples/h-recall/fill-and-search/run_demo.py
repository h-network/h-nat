...
POD = "recall_demo"
AGENT = "assistant"
DEFAULT_REDIS_URL = "redis://YOUR_REDIS_STACK_HOST:6379"
...
def main() -> int:
    ...
    facts = [
        ...
        (
            "Who leads distributed storage engine development?",
            "The lead engineer for the distributed storage engine is Dr. Elena Rostova.",
            "Stored lead storage engineer name Dr. Elena Rostova.",
        ),
    ]
    ...
    print("  -> Verified audit doc: sentinel embedding [0.0]*384 and pending_vectorize='1' present")
    ...
    print("  -> Verified audit doc: real 384d vector embedded, pending flag cleared")
    ...
    queries = [
        ...
        (
            "Who is the lead engineer for distributed storage?",
            "Dr. Elena Rostova",
            "Elena Rostova",
        ),
    ]
...
if __name__ == "__main__":
    try:
        sys.exit(main())
    except (AssertionError, RedisError, RuntimeError) as exc:
