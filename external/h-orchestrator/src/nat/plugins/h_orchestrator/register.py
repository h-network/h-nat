...
from ._openshell import create_openshell_client
...
def _client(config: AgentInvokeConfig) -> Any:
    return create_openshell_client(
        gateway_home=config.gateway_home,
...
from . import chat_cycle, claude_stream, gated_mcp  # noqa: F401
